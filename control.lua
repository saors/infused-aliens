...
script.on_event(defines.events.on_entity_died, function(event)
    local ent = event.entity
    if  ent.name == 'radioactive-small-biter' or ent.name == 'radioactive-small-spitter'  then
        release_radiation(ent, 1)
    elseif ent.name == 'radioactive-medium-biter' or ent.name == 'radioactive-medium-spitter' then
        release_radiation(ent, 2)
    elseif ent.name == 'radioactive-big-biter' or ent.name == 'radioactive-big-spitter' then
        release_radiation(ent, 3)
    elseif ent.name == 'radioactive-behemoth-biter' or ent.name == 'radioactive-behemoth-spitter' then
        release_radiation(ent, 4)
    elseif string.match(ent.name, 'spawner') and string.match(ent.name, 'radioactive') then
        release_radiation(ent, 4)
    end
